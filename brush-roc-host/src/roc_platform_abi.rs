...
#[repr(u8)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HostRegexIsMatchResultTag {
    Err = 0,
    Ok = 1,
}
...
#[repr(C)]
#[derive(Clone, Copy)]
pub union HostRegexIsMatchResultPayload {
...
#[repr(align(4))]
#[derive(Clone, Copy)]
pub struct HostRegexIsMatchResultPayloadAlignment;

/// Tag union: Try
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostRegexIsMatchResult {
    pub _payload_alignment: [HostRegexIsMatchResultPayloadAlignment; 0],
    pub payload: [u8; 12],
    pub tag: HostRegexIsMatchResultTag,
}
...
#[derive(Clone, Copy)]
pub struct HostRegexIsMatchResult {
    pub payload: HostRegexIsMatchResultPayload,
    pub tag: HostRegexIsMatchResultTag,
}

impl HostRegexIsMatchResult {
    /// Borrow the `Err` payload without creating another owner.
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexIsMatchResultTag::Err` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexIsMatchResultTag::Err`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexIsMatchResultTag::Ok` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn borrow_payload_ok_unchecked(&self) -> &bool {
        unsafe { &*(self.payload.as_ptr() as *const bool) }
    }
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexIsMatchResultTag::Ok`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn take_payload_ok_unchecked(&mut self) -> bool {
        unsafe { core::ptr::read(self.payload.as_ptr() as *const bool) }
    }
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<HostRegexIsMatchResult>() == 32, "HostRegexIsMatchResult size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<HostRegexIsMatchResult>() == 8, "HostRegexIsMatchResult alignment mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(HostRegexIsMatchResult, tag) == 24, "HostRegexIsMatchResult tag offset mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<HostRegexIsMatchResult>() == 16, "HostRegexIsMatchResult size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<HostRegexIsMatchResult>() == 4, "HostRegexIsMatchResult alignment mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::offset_of!(HostRegexIsMatchResult, tag) == 12, "HostRegexIsMatchResult tag offset mismatch");

/// Tag discriminant for Try.
#[repr(u8)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HostRegexReplaceAllResultTag {
    Err = 0,
    Ok = 1,
}
...
#[repr(C)]
#[derive(Clone, Copy)]
pub union HostRegexReplaceAllResultPayload {
    pub err: core::mem::ManuallyDrop<RocStr>,
    pub ok: core::mem::ManuallyDrop<RocStr>,
}
...
#[repr(align(4))]
#[derive(Clone, Copy)]
pub struct HostRegexReplaceAllResultPayloadAlignment;

/// Tag union: Try
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostRegexReplaceAllResult {
    pub _payload_alignment: [HostRegexReplaceAllResultPayloadAlignment; 0],
    pub payload: [u8; 12],
    pub tag: HostRegexReplaceAllResultTag,
}
...
#[derive(Clone, Copy)]
pub struct HostRegexReplaceAllResult {
    pub payload: HostRegexReplaceAllResultPayload,
    pub tag: HostRegexReplaceAllResultTag,
}

impl HostRegexReplaceAllResult {
    /// Borrow the `Err` payload without creating another owner.
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexReplaceAllResultTag::Err` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn borrow_payload_err_unchecked(&self) -> &RocStr {
        unsafe { &*(self.payload.as_ptr() as *const RocStr) }
    }
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexReplaceAllResultTag::Err`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn take_payload_err_unchecked(&mut self) -> RocStr {
        unsafe { core::ptr::read(self.payload.as_ptr() as *const RocStr) }
    }
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexReplaceAllResultTag::Ok` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn borrow_payload_ok_unchecked(&self) -> &RocStr {
        unsafe { &*(self.payload.as_ptr() as *const RocStr) }
    }
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostRegexReplaceAllResultTag::Ok`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn take_payload_ok_unchecked(&mut self) -> RocStr {
        unsafe { core::ptr::read(self.payload.as_ptr() as *const RocStr) }
    }
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<HostRegexReplaceAllResult>() == 32, "HostRegexReplaceAllResult size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<HostRegexReplaceAllResult>() == 8, "HostRegexReplaceAllResult alignment mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(HostRegexReplaceAllResult, tag) == 24, "HostRegexReplaceAllResult tag offset mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<HostRegexReplaceAllResult>() == 16, "HostRegexReplaceAllResult size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<HostRegexReplaceAllResult>() == 4, "HostRegexReplaceAllResult alignment mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::offset_of!(HostRegexReplaceAllResult, tag) == 12, "HostRegexReplaceAllResult tag offset mismatch");

/// Tag discriminant for Try.
#[repr(u8)]
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum HostPathCanonicalizeResultTag {
    Err = 0,
    Ok = 1,
}
...
#[repr(C)]
#[derive(Clone, Copy)]
pub union HostPathCanonicalizeResultPayload {
    pub err: [u8; 0],
    pub ok: core::mem::ManuallyDrop<UnixBytesOrUtf8OrWindowsU16s>,
}
...
#[repr(align(4))]
#[derive(Clone, Copy)]
pub struct HostPathCanonicalizeResultPayloadAlignment;

/// Tag union: Try
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostPathCanonicalizeResult {
    pub _payload_alignment: [HostPathCanonicalizeResultPayloadAlignment; 0],
    pub payload: [u8; 16],
    pub tag: HostPathCanonicalizeResultTag,
}
...
#[derive(Clone, Copy)]
pub struct HostPathCanonicalizeResult {
    pub payload: HostPathCanonicalizeResultPayload,
    pub tag: HostPathCanonicalizeResultTag,
}

impl HostPathCanonicalizeResult {
    /// Borrow the `Ok` payload without creating another owner.
    ///
    /// # Safety
    /// `self.tag` must be `HostPathCanonicalizeResultTag::Ok` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn borrow_payload_ok_unchecked(&self) -> &UnixBytesOrUtf8OrWindowsU16s {
        unsafe { &*(self.payload.as_ptr() as *const UnixBytesOrUtf8OrWindowsU16s) }
    }
    ...
    ///
    /// # Safety
    /// `self.tag` must be `HostPathCanonicalizeResultTag::Ok`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
    pub unsafe fn take_payload_ok_unchecked(&mut self) -> UnixBytesOrUtf8OrWindowsU16s {
        unsafe { core::ptr::read(self.payload.as_ptr() as *const UnixBytesOrUtf8OrWindowsU16s) }
    }
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<HostPathCanonicalizeResult>() == 40, "HostPathCanonicalizeResult size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<HostPathCanonicalizeResult>() == 8, "HostPathCanonicalizeResult alignment mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(HostPathCanonicalizeResult, tag) == 32, "HostPathCanonicalizeResult tag offset mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<HostPathCanonicalizeResult>() == 20, "HostPathCanonicalizeResult size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<HostPathCanonicalizeResult>() == 4, "HostPathCanonicalizeResult alignment mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::offset_of!(HostPathCanonicalizeResult, tag) == 16, "HostPathCanonicalizeResult tag offset mismatch");
...
#[repr(align(4))]
#[derive(Clone, Copy)]
pub struct TryType156PayloadAlignment;

/// Tag union: Try
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct TryType156 {
    pub _payload_alignment: [TryType156PayloadAlignment; 0],
    pub payload: [u8; 4],
    pub tag: TryType156Tag,
}
...
impl TryType156 {
    ...
    ///
    /// # Safety
    /// `self.tag` must be `TryType156Tag::Err` and the payload must still be initialized.
    #[cfg(target_pointer_width = "32")]
    ...
    ///
    /// # Safety
    /// `self.tag` must be `TryType156Tag::Err`. After this call, `self` is logically uninitialized and must not be read or destroyed.
    #[cfg(target_pointer_width = "32")]
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<TryType156>() == 8, "TryType156 size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<TryType156>() == 4, "TryType156 alignment mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(TryType156, tag) == 4, "TryType156 tag offset mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<TryType156>() == 8, "TryType156 size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<TryType156>() == 4, "TryType156 alignment mismatch");
...
/// Arguments for Host.cmd_exec_output_inherit_stdin!
/// Roc signature: { args : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), clear_envs : Bool, envs : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), program : [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))] } => Try({ stderr_bytes : List(U8), stdout_bytes : List(U8) }, [FailedToGetExitCode(IOErr), NonZeroExitCode({ exit_code : I32, stderr_bytes : List(U8), stdout_bytes : List(U8) })])
/// Refcounted fields are owned by the hosted function.
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostCmdExecOutputInheritStdinArgs {
    pub args: RocList<UnixBytesOrUtf8OrWindowsU16s>,
    pub envs: RocList<UnixBytesOrUtf8OrWindowsU16s>,
    pub program: UnixBytesOrUtf8OrWindowsU16s,
    pub clear_envs: bool,
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<HostCmdExecOutputInheritStdinArgs>() == 88, "HostCmdExecOutputInheritStdinArgs size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<HostCmdExecOutputInheritStdinArgs>() == 8, "HostCmdExecOutputInheritStdinArgs alignment mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<HostCmdExecOutputInheritStdinArgs>() == 44, "HostCmdExecOutputInheritStdinArgs size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<HostCmdExecOutputInheritStdinArgs>() == 4, "HostCmdExecOutputInheritStdinArgs alignment mismatch");

impl HostCmdExecOutputInheritStdinArgs {
    /// Recursively decrement Roc-owned fields.
    ///
    /// # Safety
    /// `self` must own one live Roc reference for each refcounted field.
...
pub struct HostCmdExecOutputInheritStdinArgsRelease;

unsafe impl RocRelease<HostCmdExecOutputInheritStdinArgs> for HostCmdExecOutputInheritStdinArgsRelease {
    unsafe fn release(value: HostCmdExecOutputInheritStdinArgs, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}

/// Arguments for Host.cmd_exec_status!
/// Roc signature: { args : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), clear_envs : Bool, envs : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), program : [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))] } => Try(I32, IOErr)
/// Refcounted fields are owned by the hosted function.
#[cfg(target_pointer_width = "32")]
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostCmdExecStatusArgs {
    pub args: RocList<UnixBytesOrUtf8OrWindowsU16s>,
    pub envs: RocList<UnixBytesOrUtf8OrWindowsU16s>,
    pub program: UnixBytesOrUtf8OrWindowsU16s,
    pub clear_envs: bool,
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::size_of::<HostCmdExecStatusArgs>() == 88, "HostCmdExecStatusArgs size mismatch");
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::align_of::<HostCmdExecStatusArgs>() == 8, "HostCmdExecStatusArgs alignment mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::size_of::<HostCmdExecStatusArgs>() == 44, "HostCmdExecStatusArgs size mismatch");
#[cfg(target_pointer_width = "32")]
const _: () = assert!(core::mem::align_of::<HostCmdExecStatusArgs>() == 4, "HostCmdExecStatusArgs alignment mismatch");

impl HostCmdExecStatusArgs {
    /// Recursively decrement Roc-owned fields.
    ///
    /// # Safety
    /// `self` must own one live Roc reference for each refcounted field.
...
pub struct HostCmdExecStatusArgsRelease;

unsafe impl RocRelease<HostCmdExecStatusArgs> for HostCmdExecStatusArgsRelease {
    unsafe fn release(value: HostCmdExecStatusArgs, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}
...
/// Arguments for Host.file_set_executable!
/// Roc signature: [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))], Bool => Try({}, [FileErr(IOErr)])
/// Refcounted fields are owned by the hosted function.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostFileSetExecutableArgs {
    pub arg0: UnixBytesOrUtf8OrWindowsU16s,
    pub arg1: bool,
}
...
/// Roc signature: [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))] => Try([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))], [CanonicalizeFailed])
/// Refcounted fields are owned by the hosted function.
#[repr(C)]
#[derive(Clone, Copy)]
...
/// Arguments for Host.regex_is_match!
/// Roc signature: Str, Str => Try(Bool, [RegexErr(Str)])
/// Refcounted fields are owned by the hosted function.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostRegexIsMatchArgs {
    pub arg0: RocStr,
    pub arg1: RocStr,
}

/// Arguments for Host.regex_replace_all!
/// Roc signature: Str, Str, Str => Try(Str, [RegexErr(Str)])
/// Refcounted fields are owned by the hosted function.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostRegexReplaceAllArgs {
    pub arg0: RocStr,
    pub arg1: RocStr,
    pub arg2: RocStr,
}
...
/// Arguments for Host.tty_is_terminal!
/// Roc signature: U64 => Bool
/// Refcounted fields are owned by the hosted function.
#[repr(C)]
#[derive(Clone, Copy)]
pub struct HostTtyIsTerminalArgs {
    pub arg0: u64,
}
...
pub type HostCmdExecOutputInheritStdinArg0 = AnonStruct32ddec9aa3de7110;
pub type HostCmdExecOutputInheritStdinArg0Args = UnixBytesOrUtf8OrWindowsU16s;
pub type HostCmdExecOutputInheritStdinArg0ArgsPayload = UnixBytesOrUtf8OrWindowsU16sPayload;
pub type HostCmdExecOutputInheritStdinArg0ArgsTag = UnixBytesOrUtf8OrWindowsU16sTag;
pub type HostCmdExecOutputInheritStdinArg0Envs = UnixBytesOrUtf8OrWindowsU16s;
pub type HostCmdExecOutputInheritStdinArg0EnvsPayload = UnixBytesOrUtf8OrWindowsU16sPayload;
pub type HostCmdExecOutputInheritStdinArg0EnvsTag = UnixBytesOrUtf8OrWindowsU16sTag;
pub type HostCmdExecOutputInheritStdinResult = HostCmdExecOutputResult;
pub type HostCmdExecOutputInheritStdinResultPayload = HostCmdExecOutputResultPayload;
pub type HostCmdExecOutputInheritStdinResultTag = HostCmdExecOutputResultTag;
pub type HostCmdExecOutputInheritStdinErr = FailedToGetExitCodeOrNonZeroExitCode;
pub type HostCmdExecOutputInheritStdinErrPayload = FailedToGetExitCodeOrNonZeroExitCodePayload;
pub type HostCmdExecOutputInheritStdinErrTag = FailedToGetExitCodeOrNonZeroExitCodeTag;
pub type HostCmdExecOutputInheritStdinErrNonZeroExitCode = AnonStruct3f89ee1e14924626;
pub type HostCmdExecOutputInheritStdinOk = AnonStruct3e7554e024207e25;
pub type HostCmdExecStatusArg0 = AnonStruct32ddec9aa3de7110;
pub type HostCmdExecStatusArg0Args = UnixBytesOrUtf8OrWindowsU16s;
pub type HostCmdExecStatusArg0ArgsPayload = UnixBytesOrUtf8OrWindowsU16sPayload;
pub type HostCmdExecStatusArg0ArgsTag = UnixBytesOrUtf8OrWindowsU16sTag;
pub type HostCmdExecStatusArg0Envs = UnixBytesOrUtf8OrWindowsU16s;
pub type HostCmdExecStatusArg0EnvsPayload = UnixBytesOrUtf8OrWindowsU16sPayload;
pub type HostCmdExecStatusArg0EnvsTag = UnixBytesOrUtf8OrWindowsU16sTag;
pub type HostCmdExecStatusResult = HostCmdExecExitCodeResult;
pub type HostCmdExecStatusResultPayload = HostCmdExecExitCodeResultPayload;
pub type HostCmdExecStatusResultTag = HostCmdExecExitCodeResultTag;
...
pub type HostFileSetExecutableResult = HostFileDeleteResult;
pub type HostFileSetExecutableResultPayload = HostFileDeleteResultPayload;
pub type HostFileSetExecutableResultTag = HostFileDeleteResultTag;
...
impl HostRegexIsMatchResult {
    ...
    pub unsafe fn decref(self, roc_host: &RocHost) {
        ...
        let _ = roc_host;
        match value.tag {
            HostRegexIsMatchResultTag::Err => {
                let payload = unsafe { value.take_payload_err_unchecked() };
                unsafe { payload.decref(roc_host); }
            },
            HostRegexIsMatchResultTag::Ok => {},
        }
    }
...
pub struct HostRegexIsMatchResultRelease;

unsafe impl RocRelease<HostRegexIsMatchResult> for HostRegexIsMatchResultRelease {
    unsafe fn release(value: HostRegexIsMatchResult, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}
...
impl HostRegexReplaceAllResult {
    ...
    pub unsafe fn decref(self, roc_host: &RocHost) {
        ...
        let _ = roc_host;
        match value.tag {
            HostRegexReplaceAllResultTag::Err => {
                let payload = unsafe { value.take_payload_err_unchecked() };
                unsafe { payload.decref(roc_host); }
            },
            HostRegexReplaceAllResultTag::Ok => {
                let payload = unsafe { value.take_payload_ok_unchecked() };
                unsafe { payload.decref(roc_host); }
            },
        }
...
pub struct HostRegexReplaceAllResultRelease;

unsafe impl RocRelease<HostRegexReplaceAllResult> for HostRegexReplaceAllResultRelease {
    unsafe fn release(value: HostRegexReplaceAllResult, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}
...
impl HostPathCanonicalizeResult {
    ...
    pub unsafe fn decref(self, roc_host: &RocHost) {
        ...
        let _ = roc_host;
        match value.tag {
            HostPathCanonicalizeResultTag::Err => {},
            HostPathCanonicalizeResultTag::Ok => {
                let payload = unsafe { value.take_payload_ok_unchecked() };
                unsafe { payload.decref(roc_host); }
            },
        }
...
pub struct HostPathCanonicalizeResultRelease;

unsafe impl RocRelease<HostPathCanonicalizeResult> for HostPathCanonicalizeResultRelease {
    unsafe fn release(value: HostPathCanonicalizeResult, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}
...
pub struct TryType156Release;

unsafe impl RocRelease<TryType156> for TryType156Release {
    unsafe fn release(value: TryType156, roc_host: &RocHost) {
        unsafe { value.decref(roc_host); }
    }
}
...
unsafe extern "C" {
    ...
    pub fn hosted_cmd_exec_exit_code(arg0: HostCmdExecExitCodeArgs) -> HostCmdExecExitCodeResult;
    ...
    ///     unsafe { arg0.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_cmd_exec_output(arg0: HostCmdExecOutputArgs) -> HostCmdExecOutputResult;

    /// Hosted symbol for Host.cmd_exec_output_inherit_stdin!
    /// Roc signature: { args : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), clear_envs : Bool, envs : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), program : [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))] } => Try({ stderr_bytes : List(U8), stdout_bytes : List(U8) }, [FailedToGetExitCode(IOErr), NonZeroExitCode({ exit_code : I32, stderr_bytes : List(U8), stdout_bytes : List(U8) })])
    /// Owned arguments. Release each exactly once before returning, unless it is
    /// moved into storage or into the result:
    ///     unsafe { arg0.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_cmd_exec_output_inherit_stdin(arg0: HostCmdExecOutputInheritStdinArgs) -> HostCmdExecOutputResult;

    /// Hosted symbol for Host.cmd_exec_status!
    /// Roc signature: { args : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), clear_envs : Bool, envs : List([UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))]), program : [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))] } => Try(I32, IOErr)
    /// Owned arguments. Release each exactly once before returning, unless it is
    /// moved into storage or into the result:
    ///     unsafe { arg0.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_cmd_exec_status(arg0: HostCmdExecStatusArgs) -> HostCmdExecExitCodeResult;
    ...
    /// Hosted symbol for Host.env_num_cpus!
    /// Roc signature: {} => I64
    pub fn hosted_env_num_cpus() -> i64;

    /// Hosted symbol for Host.env_pid!
    /// Roc signature: {} => I64
    pub fn hosted_env_pid() -> i64;
    ...
    /// Hosted symbol for Host.env_tz_offset!
    /// Roc signature: {} => I64
    pub fn hosted_env_tz_offset() -> i64;
    ...
    /// Hosted symbol for Host.file_set_executable!
    /// Roc signature: [UnixBytes(List(U8)), Utf8(Str), WindowsU16s(List(U16))], Bool => Try({}, [FileErr(IOErr)])
    /// Owned arguments. Release each exactly once before returning, unless it is
    /// moved into storage or into the result:
    ///     unsafe { arg0.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_file_set_executable(arg0: UnixBytesOrUtf8OrWindowsU16s, arg1: bool) -> HostFileDeleteResult;
    ...
    ///     unsafe { arg0.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_path_canonicalize(arg0: UnixBytesOrUtf8OrWindowsU16s) -> HostPathCanonicalizeResult;
    ...
    /// Hosted symbol for Host.regex_is_match!
    /// Roc signature: Str, Str => Try(Bool, [RegexErr(Str)])
    /// Owned arguments. Release each exactly once before returning, unless it is
    /// moved into storage or into the result:
    ///     unsafe { arg0.decref(roc_host); }
    ///     unsafe { arg1.decref(roc_host); }
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_regex_is_match(arg0: RocStr, arg1: RocStr) -> HostRegexIsMatchResult;

    /// Hosted symbol for Host.regex_replace_all!
    /// Roc signature: Str, Str, Str => Try(Str, [RegexErr(Str)])
    /// Owned arguments. Release each exactly once before returning, unless it is
    /// moved into storage or into the result:
    ///     unsafe { arg0.decref(roc_host); }
    ...
    /// The result is owned by Roc: return exactly one owned reference.
    pub fn hosted_regex_replace_all(arg0: RocStr, arg1: RocStr, arg2: RocStr) -> HostRegexReplaceAllResult;

    /// Hosted symbol for Host.signal_install_handler!
    /// Roc signature: {} => {}
    pub fn hosted_signal_install_handler();

    /// Hosted symbol for Host.signal_take!
    /// Roc signature: {} => I64
    pub fn hosted_signal_take() -> i64;
    ...
    /// Hosted symbol for Host.tty_is_terminal!
    /// Roc signature: U64 => Bool
    pub fn hosted_tty_is_terminal(arg0: u64) -> bool;
